...
import { Activity, Users, BookOpen, Clock, Download } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { l: "Active Learners", v: 234, icon: Users },
          { l: "Completions", v: 89, icon: BookOpen },
          { l: "Avg Progress", v: "64%", icon: Activity },
          { l: "Avg Watch Time", v: "42m", icon: Clock }
        ].map(s => (
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              { name: "Introduction to Ultrasound", pct: 78 },
              { name: "Advanced Echo Techniques", pct: 62 },
              { name: "Pediatric Cardiology", pct: 45 },
              { name: "Emergency Ultrasound", pct: 91 },
            ].map(c => (
